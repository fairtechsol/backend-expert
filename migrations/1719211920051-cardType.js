...
module.exports = class CardType1719211920051 {
    name = 'CardType1719211920051'
    ...
    async down(queryRunner) {
        await queryRunner.query(`CREATE TYPE "public"."cardMatchs_type_enum_old" AS ENUM('abj', 'card32', 'dt20', 'lucky7', 'teen20')`);
