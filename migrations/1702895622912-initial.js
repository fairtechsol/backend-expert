...
module.exports = class Initial1702895622912 {
    name = 'Initial1702895622912'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "matchBettings" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createBy" uuid, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "matchId" uuid NOT NULL, "type" "public"."matchBettings_type_enum" NOT NULL, "name" character varying NOT NULL, "minBet" double precision NOT NULL DEFAULT '0', "maxBet" double precision NOT NULL DEFAULT '1', "backTeamA" double precision NOT NULL DEFAULT '0', "backTeamB" double precision NOT NULL DEFAULT '0', "backTeamC" double precision NOT NULL DEFAULT '0', "layTeamA" double precision NOT NULL DEFAULT '0', "layTeamB" double precision NOT NULL DEFAULT '0', "layTeamC" double precision NOT NULL DEFAULT '0', "statusTeamA" "public"."matchBettings_statusteama_enum" NOT NULL DEFAULT 'suspended', "statusTeamB" "public"."matchBettings_statusteamb_enum" NOT NULL DEFAULT 'suspended', "statusTeamC" "public"."matchBettings_statusteamc_enum" DEFAULT 'suspended', "activeStatus" "public"."matchBettings_activestatus_enum" NOT NULL DEFAULT 'live', "stopAt" TIMESTAMP WITH TIME ZONE, CONSTRAINT "matchBetting_minBet" CHECK ("minBet" >= 0), CONSTRAINT "matchBetting_maxBet" CHECK ("maxBet" > "minBet"), CONSTRAINT "PK_a138f4924e867722232da45ae38" PRIMARY KEY ("id"))`);
