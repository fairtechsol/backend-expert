...
module.exports = class Initial1701925018599 {
    name = 'Initial1701925018599'

    async up(queryRunner) {
        await queryRunner.query(`CREATE TYPE "public"."bettings_betstatus_enum" AS ENUM('save', 'live', 'result', 'close')`);
        await queryRunner.query(`CREATE TABLE "bettings" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "matchId" uuid NOT NULL, "matchType" character varying(50) NOT NULL, "betCondition" character varying(200) NOT NULL, "noRate" double precision, "yesRate" double precision, "ratePercent" character varying(50), "sessionStatus" character varying(50) DEFAULT 'suspended', "selectionId" character varying, "sessionBet" boolean NOT NULL DEFAULT true, "betStatus" "public"."bettings_betstatus_enum" NOT NULL DEFAULT 'save', "stopAt" TIMESTAMP WITH TIME ZONE, "betResult" character varying, "sessionMinBet" double precision, "sessionMaxBet" double precision, CONSTRAINT "UQ_1e70b1452c95244c9f8bceae02b" UNIQUE ("matchId"), CONSTRAINT "PK_18baabb46e8b30402aca9c7fdb8" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "bookmakers" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "matchId" uuid NOT NULL, "betId" uuid NOT NULL, "matchType" character varying(50) NOT NULL, "marketType" character varying(50) NOT NULL, "marketName" character varying(50) NOT NULL, "minBet" double precision, "maxBet" double precision, "teamABack" double precision, "teamBBack" double precision, "teamCBack" double precision, "teamAStatus" character varying DEFAULT 'suspended', "teamBStatus" character varying DEFAULT 'suspended', "teamCStatus" character varying DEFAULT 'suspended', "teamALay" double precision, "teamBLay" double precision, "teamCLay" double precision, "betStatus" "public"."bookmakers_betstatus_enum" NOT NULL DEFAULT 'save', CONSTRAINT "UQ_24e1529b766485122592c40366c" UNIQUE ("matchId"), CONSTRAINT "UQ_4de06438acfb3fbd694f60ad055" UNIQUE ("betId"), CONSTRAINT "PK_f75b6ecebd5c6a9df57492e0b3a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "bookmaker_marketName" ON "bookmakers" ("matchId", "marketName") `);
        await queryRunner.query(`CREATE TABLE "matchs" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createBy" uuid, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE, "gameType" character varying(50) NOT NULL, "competitionId" character varying NOT NULL, "competitionName" character varying NOT NULL, "title" character varying(100) NOT NULL, "marketId" character varying NOT NULL, "eventId" character varying NOT NULL, "teamA" character varying(100) NOT NULL, "teamB" character varying(100) NOT NULL, "teamC" character varying(100), "startAt" TIMESTAMP WITH TIME ZONE NOT NULL, "stopAt" TIMESTAMP WITH TIME ZONE, "matchOddMinBet" double precision NOT NULL DEFAULT '0', "matchOddMaxBet" double precision NOT NULL DEFAULT '0', "betFairSessionMinBet" double precision NOT NULL DEFAULT '0', "betFairSessionMaxBet" double precision NOT NULL DEFAULT '0', "betFairBookmakerMinBet" double precision NOT NULL DEFAULT '0', "betFairBookmakerMaxBet" double precision NOT NULL DEFAULT '0', "apiMatchOddActive" boolean NOT NULL DEFAULT false, "apiBookMakerActive" boolean NOT NULL DEFAULT false, "apiSessionActive" boolean NOT NULL DEFAULT false, "manualBookMakerActive" boolean NOT NULL DEFAULT false, "manualSessionActive" boolean NOT NULL DEFAULT false, "delaySecond" integer, CONSTRAINT "PK_0fdbc8e05ccfb9533008b132189" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "match_marketId" ON "matchs" ("marketId", "gameType") `);
