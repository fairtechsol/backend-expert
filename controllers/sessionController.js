...
const { getAllSessionRedis, getSessionFromRedis, settingAllSessionMatchRedis, updateSessionMatchRedis, hasSessionInCache, addAllsessionInRedis, hasMatchInCache, getMultipleMatchKey, updateMarketSessionIdRedis, getUserRedisData, deleteKeyFromMarketSessionId, getExpertsRedisSessionData, updateMultipleMarketSessionIdRedis, updateMatchInCache, updateMatchKeyInCache, getUserSessionAllPL } = require("../services/redis/commonfunction");
...
exports.sessionProfitLossUserWise = async (req, res) => {
  try {
...
exports.sessionProfitLossBets = async (req, res) => {
  try {
