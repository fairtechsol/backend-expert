...
router.post("/declare/result/race/match", isAuthenticate, validator(raceMatchDeclareValidator), declareRacingMatchResult);
...
router.post("/unDeclare/result/race/match", isAuthenticate, validator(raceMatchUnDeclareValidator), unDeclareRacingMatchResult);
