...
module.exports = class SystemTable1703058403990 {
    name = 'SystemTable1703058403990'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "matchBettings" ADD "isManual" boolean NOT NULL DEFAULT true`);
        await queryRunner.query(`ALTER TABLE "sessionBettings" ADD "result" character varying`);
        await queryRunner.query(`ALTER TABLE "sessionBettings" ADD "isManual" boolean NOT NULL DEFAULT true`);
        await queryRunner.query(`CREATE INDEX "matchBeting_name" ON "matchBettings" ("matchId", "name") `);
    }

    async down(queryRunner) {
        await queryRunner.query(`DROP INDEX "public"."matchBeting_name"`);
        await queryRunner.query(`ALTER TABLE "sessionBettings" DROP COLUMN "isManual"`);
        await queryRunner.query(`ALTER TABLE "sessionBettings" DROP COLUMN "result"`);
        await queryRunner.query(`ALTER TABLE "matchBettings" DROP COLUMN "isManual"`);
