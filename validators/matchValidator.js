...
module.exports.racingAddMatchValidate = Joi.object({
  ...
  runners: Joi.array().min(1).items(Joi.object({
    ...
    metadata: Joi.object({
      ...
      CLOTH_NUMBER_ALPHA: Joi.string().optional(),
      OFFICIAL_RATING: Joi.any().allow(null).optional(),
      COLOURS_DESCRIPTION: Joi.string().optional(),
      COLOURS_FILENAME: Joi.string().optional(),
      FORECASTPRICE_DENOMINATOR: Joi.string().optional(),
      DAMSIRE_NAME: Joi.string().allow(null).optional(),
      WEIGHT_VALUE: Joi.number().optional(),
      SEX_TYPE: Joi.string().optional(),
      DAYS_SINCE_LAST_RUN: Joi.number().integer().optional(),
      WEARING: Joi.any().allow(null).optional(),
      OWNER_NAME: Joi.any().allow(null).optional(),
      DAM_YEAR_BORN: Joi.any().allow(null).optional(),
      SIRE_BRED: Joi.string().optional(),
      JOCKEY_NAME: Joi.string().optional(),
      DAM_BRED: Joi.string().optional(),
      ADJUSTED_RATING: Joi.any().allow(null).optional(),
      runnerId: Joi.number().integer().required(),
      CLOTH_NUMBER: Joi.string().optional(),
      SIRE_YEAR_BORN: Joi.any().allow(null).optional(),
      TRAINER_NAME: Joi.string().optional(),
      COLOUR_TYPE: Joi.string().optional(),
      AGE: Joi.number().integer().optional(),
      DAMSIRE_BRED: Joi.string().optional(),
      JOCKEY_CLAIM: Joi.any().allow(null).optional(),
      FORM: Joi.string().optional(),
      FORECASTPRICE_NUMERATOR: Joi.string().optional(),
      BRED: Joi.string().optional(),
      DAM_NAME: Joi.string().optional(),
      DAMSIRE_YEAR_BORN: Joi.any().allow(null).optional(),
      STALL_DRAW: Joi.string().optional(),
      WEIGHT_UNITS: Joi.string().optional()
    }).required()
  }))
}).messages({
  "object.base": "Invalid input. Please provide a valid object.",
