...
module.exports = class MatchBettingApiType1724131289300 {
    name = 'MatchBettingApiType1724131289300'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "matchs" ADD "apiType" integer NOT NULL DEFAULT '0'`);
    }

    async down(queryRunner) {
        await queryRunner.query(`ALTER TABLE "matchs" DROP COLUMN "apiType"`);
